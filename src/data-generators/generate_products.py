...
class ProductGenerator:
    ...
    BRANDS = [
        'TechBrand', 'StyleCo', 'HomeEssentials', 'ActiveLife',
        'ReadMore', 'PlayTime', 'BeautyPlus', 'AutoPro',
        'OfficePro', 'PetCare', 'GenericBrand', 'PremiumChoice'
    ]
    
    PRODUCT_NAMES = {
        'Electronics': ['Wireless Mouse', 'Keyboard', 'Monitor', 'Headphones', 'Webcam', 'USB Cable', 'Phone Case', 'Charger'],
        'Clothing': ['T-Shirt', 'Jeans', 'Dress', 'Jacket', 'Sneakers', 'Hat', 'Socks', 'Sweater'],
        'Home & Garden': ['Lamp', 'Pillow', 'Blanket', 'Plant Pot', 'Candle', 'Picture Frame', 'Vase', 'Rug'],
        'Sports & Outdoors': ['Yoga Mat', 'Dumbbells', 'Water Bottle', 'Backpack', 'Tent', 'Sleeping Bag', 'Bike Helmet'],
        'Books': ['Fiction Novel', 'Cookbook', 'Self-Help Book', 'Biography', 'Textbook', 'Comic Book', 'Magazine'],
        'Toys & Games': ['Board Game', 'Puzzle', 'Action Figure', 'Doll', 'Building Blocks', 'Card Game', 'Stuffed Animal'],
        'Health & Beauty': ['Shampoo', 'Moisturizer', 'Vitamins', 'Toothpaste', 'Makeup', 'Perfume', 'Soap'],
        'Automotive': ['Car Wax', 'Oil Filter', 'Air Freshener', 'Phone Mount', 'Jumper Cables', 'Tire Gauge'],
        'Office Supplies': ['Notebook', 'Pen Set', 'Stapler', 'Desk Organizer', 'Paper', 'Folders', 'Tape'],
        'Pet Supplies': ['Dog Food', 'Cat Toy', 'Pet Bed', 'Leash', 'Food Bowl', 'Treats', 'Collar']
    }
    ...
    def generate_product(self, product_id):
        ...
        if random.random() < 0.3:
            name += f" {random.choice(['Pro', 'Plus', 'Premium', 'Deluxe', 'Standard'])}"
