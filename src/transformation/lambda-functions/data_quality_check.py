...
class DataQualityChecker:
    ...
    def check_null_percentages(self, table_name: str, columns: List[str],
                               max_null_pct: float = 0.1) -> bool:
    ...
    def check_data_freshness(self, table_name: str, date_column: str,
        ...
        try:
            ...
            self.checks_passed.append({
                'check': check_name,
                'value': f'{age_hours:.1f} hours old'
            })
            return True
...
def lambda_handler(event, context):
    ...
    try:
        ...
        checker.check_data_freshness('transactions', 'transaction_date', max_age_hours=48)
