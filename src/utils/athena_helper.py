...
class AthenaHelper:
    ...
    def wait_for_query(
        self, query_execution_id: str, max_wait_seconds: int = 300
    ) -> str:
        """
    ...
    def get_query_results(
        ...
        try:
            ...
            logger.info(
                f"Retrieved {len(results)} results from query {query_execution_id}"
            )
            return results
        except ClientError as e:
    ...
    def execute_and_get_results(
        self, query: str, database: str = "default", max_results: int = 1000
    ) -> List[Dict]:
        """
    ...
    def create_named_query(
        self, name: str, query: str, database: str, description: str = ""
    ) -> Optional[str]:
        """
